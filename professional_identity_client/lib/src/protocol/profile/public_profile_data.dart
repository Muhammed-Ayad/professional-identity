...
abstract class PublicProfileData
  ...
  factory PublicProfileData.fromJson(Map<String, dynamic> jsonSerialization) {
    return PublicProfileData(
      ...
      isPublic: _isc.BoolJsonExtension.fromJson(jsonSerialization['isPublic']),
      skills: _ixcjy4bn.Protocol().deserialize<List<_iyfor54a.Skill>>(
        jsonSerialization['skills'],
      ),
      experiences: _ixcjy4bn.Protocol().deserialize<List<_iot70o80.Experience>>(
        jsonSerialization['experiences'],
      ),
      projects: _ixcjy4bn.Protocol().deserialize<List<_ivtjr8tj.Project>>(
        jsonSerialization['projects'],
      ),
      socialLinks: _ixcjy4bn.Protocol().deserialize<List<_i3diedg0.SocialLink>>(
        jsonSerialization['socialLinks'],
      ),
      customization: jsonSerialization['customization'] == null
          ? null
          : _ixcjy4bn.Protocol().deserialize<_i807syeh.ProfileCustomization>(
